...
public class RotatableVoxelShape {
	...
	public static Vec3d[] rotatedBox(Vec3d min, Vec3d max, Direction direction){
		return switch (direction) {
			...
			case EAST -> new Vec3d[]{new Vec3d(16d - max.z, min.y, min.x), new Vec3d(16d - min.z, max.y, max.x)};
			case WEST -> new Vec3d[]{new Vec3d(min.z, min.y, 16d - max.x), new Vec3d(max.z, max.y, 16d - min.x)};
		};
	}
}
